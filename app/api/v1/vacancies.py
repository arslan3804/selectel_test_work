...
from app.schemas.errors import NOT_FOUND_RESPONSE, ALREADY_EXISTS_RESPONSE
...
@router.get("/{vacancy_id}", response_model=VacancyRead, responses=NOT_FOUND_RESPONSE)
...
@router.post("/", response_model=VacancyRead, status_code=status.HTTP_201_CREATED, responses=ALREADY_EXISTS_RESPONSE)
...
@router.put("/{vacancy_id}", response_model=VacancyRead, responses={**NOT_FOUND_RESPONSE, **ALREADY_EXISTS_RESPONSE})
...
@router.delete("/{vacancy_id}", status_code=status.HTTP_204_NO_CONTENT, responses=NOT_FOUND_RESPONSE)
